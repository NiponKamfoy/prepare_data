def Config():
    config = {
                "read_nc_path" : r"F:\New_data", # path of NC file use to create Json data
                ...
                "lat_lon_path": r"C:\Users\s6201\OneDrive\เอกสาร\lonlat_rcm_5km_TH.csv", # paht of lat,lon file use to create NC data
